...
Six end-to-end projects, each public, MIT-licensed, and carrying the committed
report the numbers on the site are read from:
...
`CV.md` in this repository is the current CV.
